            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/work-unit'); ?>">Tim Kerja</a></li>
                        <li class="breadcrumb-item active">Tambah Unit Kerja</li>
                    </ol>
                </div>
                <h4 class="page-title">Form Tambah Tim Kerja</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <form method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="unit_name" placeholder="Masukkan nama unit" value="<?= set_value('unit_name') ?>">
