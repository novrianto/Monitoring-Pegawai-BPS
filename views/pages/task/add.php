    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Form Tambah Tugas</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <form method="post">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="task_name" placeholder="Masukkan nama tugas" value="<?= set_value('task_name') ?>">
                                <small class="text-danger"> <?= form_error('task_name') ?></small>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="col-form-label">Beban Kerja</label>
                                <input type="number" class="form-control" name="task_point" placeholder="Masukkan jumlah beban kerja" value="<?= set_value('task_point') ?>">
                                <small class="text-danger"> <?= form_error('task_point') ?></small>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="col-form-label">Deskripsi</label>
                                <input type="text" class="form-control" name="description" placeholder="Masukkan deskripsi" value="<?= set_value('description') ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" id="work_unit_id" name="work_unit_id">
                                    ...
                                    <?php foreach ($arrUnit as $unit) : ?>
                                        <option value="<?= $unit->work_unit_id ?>"><?= $unit->unit_name ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="form-group col-md-4">
